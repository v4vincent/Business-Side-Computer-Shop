...
class PartTest {
    ...
    @Test
    void testMinInventorySetAndGet() {
        partIn = new InhousePart();
        partOut = new OutsourcedPart();
        partIn.setMinInv(10);
        partOut.setMinInv(15);

        int partInMinInv = partIn.getMinInv();
        int partOutMinInv = partOut.getMinInv();
        assertEquals(10, partInMinInv);
        assertEquals(15, partOutMinInv);
    }
    @Test
    void testMaxInventorySetAndGet() {
        partIn = new InhousePart();
        partOut = new OutsourcedPart();
        partIn.setMaxInv(100);
        partOut.setMaxInv(150);

        int partInMaxInv = partIn.getMaxInv();
        int partOutMaxInv = partOut.getMaxInv();
        assertEquals(100, partInMaxInv);
        assertEquals(150, partOutMaxInv);
    }
